$(function(){
	...
	$(".focusPic_close").on("click",function(){
		if(isFlag) {
			$("#focusPic img").attr("src","static/img/adtop.jpg").css({"top":0});
			$("#focusPic").animate({"height":270},1000);
			$(".focusPic_close").text("收起");
			isFlag = false;
		} else {
		    $("#focusPic").animate({"height":160});
			$("#focusPic img").attr("src","static/img/indextop.jpg");
 ...
 //    	});
	...
	$(".search").focus(function(){
		$("#searchBtnlist").css({"display":"block;"});
	});
	$(".search").blur(function(){
		$("#searchBtnlist").css({"display":"none;"});
	});
			...
			$.getJSON(
				...
				function (data) {
					...
					$.each($arr,function(n,value){
			        	...
			        	//$li.text()=value;
			        	//console.log(value);				
			        	$("#searchBtnlist").append("<li>"+value+"</li>");
			        });
				}
			); 
